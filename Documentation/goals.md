<Subject to change>
Easy
1. Ability to run multiple jobs simultaneously with different parameters (E.G different thresholds)
2. Export CSV to a file of choice instead of directly into directory
...
Impossible
1. Reading the CSV files and being able to re-create the video from them
2. Playing the video and creating the file live